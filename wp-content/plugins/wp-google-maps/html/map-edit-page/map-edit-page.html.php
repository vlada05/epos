			...
			<div id="wpgmaps_tabs">
				...
				<div id="general-settings">
					...
					<fieldset>
						...
						<input type="text" id="amount" style="display: none;" name="map_start_zoom"/>
				...
				<div id="store-locator">
					...
					<fieldset class="wpgmza-pro-feature">
						...
						<div class='switch'>
							<input type='checkbox'
								...
								name='wpgmza_store_locator_category_enabled' 
					...
					<fieldset class="wpgmza-pro-feature">
						...
						<input type="text" name="wpgmza_store_locator_query_string" id="wpgmza_store_locator_query_string" class="wpgmza-pro-feature"/>
					</fieldset>
					...
					<fieldset class="wpgmza-pro-feature">
						...
						<input type="text" 
							name="wpgmza_store_locator_default_address"
					...
					<fieldset class="wpgmza-pro-feature">
						...
						<div class='switch'>
							<input type='checkbox'
								...
								name='wpgmza_store_locator_name_search' 
								class='postform cmn-toggle cmn-toggle-round-flat wpgmza-pro-feature'>
					...
					<fieldset class="wpgmza-pro-feature">
						...
						<input type="text" 
							name="wpgmza_store_locator_name_string"
					...
					<fieldset class="wpgmza-pro-feature">
						...
						<input type="text"
							name="wpgmza_store_locator_not_found_message"
